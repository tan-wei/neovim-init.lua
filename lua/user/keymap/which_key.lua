...
function M.entries()
  ...
  return {
    ...
    { "<leader>m1", with_harpoon(function(_, list)
      list:select(1)
    end), desc = "select file 1", mode = "n" },
    { "<leader>m2", with_harpoon(function(_, list)
      list:select(2)
    end), desc = "select file 2", mode = "n" },
    { "<leader>m3", with_harpoon(function(_, list)
      list:select(3)
    end), desc = "select file 3", mode = "n" },
    { "<leader>m4", with_harpoon(function(_, list)
      list:select(4)
    end), desc = "select file 4", mode = "n" },
